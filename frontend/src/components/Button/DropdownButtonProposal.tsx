...
const DropdownButtonProfile = ({ values, defaultValue, onDurationChange }: Props) => {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left w-2/3">
      <div>
        <Menu.Button className="inline-flex w-2/3 justify-end rounded-md bg-slate-200 px-6 py-2 text-sm font-medium text-black hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
